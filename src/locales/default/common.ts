export default {
  ...
  'tab.eval': 'Eval Lab',
  'tab.files': 'Files',
  'generate.deleteTopicDesc': 'Are you sure you want to delete this topic? This cannot be undone.',
  'generate.deleteTopicTitle': 'Delete Topic',
  'generate.newTopic': 'New',
  'generate.untitledTopic': 'Untitled Topic',
  'tab.generate': 'Create',
  'tab.home': 'Home',
